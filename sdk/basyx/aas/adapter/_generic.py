...
REFERENCE_TYPES_INVERSE: Dict[str, Type[model.Reference]] = {
    v: k for k, v in REFERENCE_TYPES.items()
}
...
IEC61360_DATA_TYPES_INVERSE: Dict[str, model.base.DataTypeIEC61360] = {
    v: k for k, v in IEC61360_DATA_TYPES.items()
}
