...
_embedded_data_specification_iec61360 = model.EmbeddedDataSpecification(
    ...
    data_specification_content=model.DataSpecificationIEC61360(
        preferred_name=model.PreferredNameTypeIEC61360(
            {"de": "Test Specification", "en-US": "TestSpecification"}
        ),
        data_type=model.DataTypeIEC61360.REAL_MEASURE,
        definition=model.DefinitionTypeIEC61360(
            {
                "de": "Dies ist eine Data Specification für Testzwecke",
                "en-US": "This is a DataSpecification for testing purposes",
            }
        ),
        short_name=model.ShortNameTypeIEC61360({"de": "Test Spec", "en-US": "TestSpec"}),
        unit="SpaceUnit",
        unit_id=model.ExternalReference(
            (
                model.Key(
                    type_=model.KeyTypes.GLOBAL_REFERENCE, value="http://acplt.org/Units/SpaceUnit"
                ),
            )
        ),
        ...
        value="TEST",
        level_types={model.IEC61360LevelType.MIN, model.IEC61360LevelType.MAX},
    ),
)
...
def create_example_asset_identification_submodel() -> model.Submodel:
    ...
    identification_submodel_element_manufacturer_name = model.Property(
        ...
        semantic_id=model.ExternalReference(
            (model.Key(type_=model.KeyTypes.GLOBAL_REFERENCE, value="0173-1#02-AAO677#002"),)
        ),
    ...
    identification_submodel = model.Submodel(
        ...
        submodel_element=(
            identification_submodel_element_manufacturer_name,
...
def create_example_bill_of_material_submodel() -> model.Submodel:
    ...
    bill_of_material = model.Submodel(
        ...
        submodel_element=(entity, entity_2),
...
def create_example_submodel() -> model.Submodel:
    ...
    submodel_element_multi_language_property = model.MultiLanguageProperty(
        ...
        value=model.MultiLanguageTextType(
            {
                "en-US": "Example value of a MultiLanguageProperty element",
    ...
    submodel_element_relationship_element = model.RelationshipElement(
        ...
        second=model.ModelReference(
            (
                model.Key(type_=model.KeyTypes.SUBMODEL, value="http://acplt.org/Test_Submodel"),
                model.Key(type_=model.KeyTypes.PROPERTY, value="ExampleProperty2"),
            ),
            model.Property,
        ),
        category="PARAMETER",
    ...
    submodel_element_annotated_relationship_element = model.AnnotatedRelationshipElement(
        ...
        annotation={
            ...
            model.Range(
                id_short="ExampleAnnotatedRange",
    ...
    submodel_element_basic_event_element = model.BasicEventElement(
        ...
        message_broker=model.ModelReference(
            (model.Key(model.KeyTypes.SUBMODEL, "http://acplt.org/ExampleMessageBroker"),),
            model.Submodel,
        ),
        ...
        max_interval=model.datatypes.Duration(
            years=1, months=2, days=3, hours=4, minutes=5, seconds=6, microseconds=123456
        ),
        category="PARAMETER",
        description=model.MultiLanguageTextType(
            {
...
def create_example_concept_description() -> model.ConceptDescription:
    ...
    concept_description = model.ConceptDescription(
        ...
        description=model.MultiLanguageTextType(
            {
                "en-US": "An example concept description for the test application",
...
def create_example_asset_administration_shell() -> model.AssetAdministrationShell:
    ...
    asset_information = model.AssetInformation(
        ...
        specific_asset_id={
            model.SpecificAssetId(
                ...
                semantic_id=model.ExternalReference(
                    (
                        model.Key(
                            model.KeyTypes.GLOBAL_REFERENCE, "http://acplt.org/SpecificAssetId/"
                        ),
                    )
                ),
            )
        ...
        default_thumbnail=model.Resource("file:///path/to/thumbnail.png", "image/png"),
    )
    ...
    asset_administration_shell = model.AssetAdministrationShell(
        ...
        submodel={
            model.ModelReference(
                (
                    model.Key(
                        type_=model.KeyTypes.SUBMODEL, value="https://acplt.org/Test_Submodel"
                    ),
                ),
                model.Submodel,
                model.ExternalReference(
        ...
        derived_from=model.ModelReference(
            (
                model.Key(
                    type_=model.KeyTypes.ASSET_ADMINISTRATION_SHELL,
...
##############################################################################
def check_example_asset_identification_submodel(
    checker: AASDataChecker, submodel: model.Submodel
) -> None:
    expected_submodel = create_example_asset_identification_submodel()
    checker.check_submodel_equal(submodel, expected_submodel)


def check_example_bill_of_material_submodel(
    checker: AASDataChecker, submodel: model.Submodel
) -> None:
