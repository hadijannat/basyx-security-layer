...
def create_example_submodel() -> model.Submodel:
    ...
    qualifier = model.Qualifier(
        type_="http://acplt.org/Qualifier/ExampleQualifier", value_type=model.datatypes.String
    )
...
def create_example_asset_administration_shell() -> model.AssetAdministrationShell:
    ...
    resource = model.Resource(content_type="application/pdf", path="file:///TestFile.pdf")
