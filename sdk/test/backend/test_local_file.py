...
class LocalFileBackendTest(unittest.TestCase):
    ...
    def test_retrieval(self):
        ...
        test_object_retrieved.source = (
            "couchdb://example.com/example/IRI-https%3A%2F%2Facplt.org%2FTest_Submodel"
        )
    ...
    def test_key_errors(self) -> None:
        ...
        self.assertEqual(
            "'No Identifiable with id https://acplt.org/Test_Submodel "
        ...
        self.assertEqual(
            "'No AAS object with id https://acplt.org/Test_Submodel exists in "
            "local file database'",
            str(cm.exception),
        )
