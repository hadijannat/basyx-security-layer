...
class ProvidersTest(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.aas2 = model.AssetAdministrationShell(
            model.AssetInformation(global_asset_id="http://acplt.org/TestAsset2/"),
            "urn:x-test:aas2",
        )
    ...
    def test_store_retrieve(self) -> None:
        object_store: model.DictObjectStore[model.AssetAdministrationShell] = (
        ...
        aas3 = model.AssetAdministrationShell(
            model.AssetInformation(global_asset_id="http://acplt.org/TestAsset/"), "urn:x-test:aas1"
        )
        ...
        self.assertIs(self.aas1, object_store.get_identifiable("urn:x-test:aas1"))
        self.assertIs(self.aas1, object_store.get("urn:x-test:aas1"))
    ...
    def test_store_update(self) -> None:
        object_store1: model.DictObjectStore[model.AssetAdministrationShell] = (
            model.DictObjectStore()
        )
        object_store1.add(self.aas1)
        object_store2: model.DictObjectStore[model.AssetAdministrationShell] = (
            model.DictObjectStore()
        )
    ...
    def test_provider_multiplexer(self) -> None:
        aas_object_store: model.DictObjectStore[model.AssetAdministrationShell] = (
            model.DictObjectStore()
        )
        ...
        self.assertEqual(
            "'Identifier could not be found in any of the 2 consulted registries.'",
            str(cm.exception),
        )
